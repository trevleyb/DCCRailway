...
namespace DCCRailway.Core {
	public interface ISystem {
		// These two properties are needed so we can REFLECT into the assembly
		// to get this information so that we can populate a list of available 
		// command stations to be created via the DCCFactory. 
		// ----------------------------------------------------------------------------
