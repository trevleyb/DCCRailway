    ...
    private void RegisterAdapters() {
        ...
        foreach (var adapter in foundTypes) {
            ...
            if (attr != null && !string.IsNullOrEmpty(attr.Name)) {
                var adapterInterface = adapter.ImplementedInterfaces.First(x => x.FullName != null && x.FullName.StartsWith("DCCRailway.CmdStation.Adapters.", StringComparison.InvariantCultureIgnoreCase)) ?? null;
