...
public class Route(string id = "") : LayoutEntity(id) {
    ...
    public void SwapTurnout(int firstPosition, int secondPosition) {
        ...
        if (firstPosition < routesArray.Length && secondPosition < routesArray.Length &&
            firstPosition != secondPosition)
            (routesArray[firstPosition], routesArray[secondPosition]) =
                (routesArray[secondPosition], routesArray[firstPosition]);
