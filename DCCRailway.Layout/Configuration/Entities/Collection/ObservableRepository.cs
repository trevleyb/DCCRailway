...
public class ObservableRepository<TEntity> : ObservableCollection<TEntity>, IRepository<TEntity> where TEntity : IEntity {
    ...
    public ObservableRepository(string prefix) {
        Prefix = prefix;
    ...
    private async Task<int> FindIndexOf(string id) {
        return -1;
    }
