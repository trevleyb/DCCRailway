...
public class MsgStartup : ServerMsg {

    public MsgStartup(WiThrottleConnection connection, ref WiThrottleServerOptions options) : base(connection, ref options) { }
    ...
    public override void Execute(NetworkStream stream) {
        ...
        response.AppendLine($"*{Connection.HeartbeatSeconds:D2}");
