...
/*
    ...
    public class NCEPowerCabLocoFunctions {
        ...
        public void Setup() {
            ...
            Assert.IsNotNull(_system, "Should have an NCE PowerCab commandStation created.");
            Assert.IsInstanceOfType(_system, typeof(DccSystems.NCE.NCEPowerCab), "Should be a NCE:NCEPowerCab CommandStation Created");

            Assert.IsNotNull(_system.Reference, "CommandStation Reference should not be null");
