...
/// </summary>
public class CmdMultiThrottleHelper {
    private static readonly string Delimiter      = "<;>";
    private static readonly char[] ValidFunctions = ['+', '-', 'S', 'A', 'L'];

    public CmdMultiThrottleHelper(Connection connection, string commandStr) {
        //
        ...
        try {
            ...
            if (addressStr == "*") {
                Addresses   = connection.AssignedLocos(Group).ToArray();
                IsBroadcast = true;
            } else {
