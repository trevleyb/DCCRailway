    ...
    public void Execute(string commandStr)
    {
        ...
        if (commandStr.Length > 2)
            ...
            case 'U':
                ...
                {
                    logger.Information("WiThrottle Duplicate HardwareIDs found {0}:{1} - re-using previous connection.",
                ...
                logger.Information("WiThrottle Duplicate HardwareIDs {0}:{2} ==> '{1}'", ToString(), hardwareID,
                                   connection.ToString());
